...
import { loginWithEmailAndPassword, getAuthCookieOptions, AUTH_SESSION_COOKIE_NAME, AuthValidationError } from "@/lib/server/auth";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await loginWithEmailAndPassword(email, password, { ipAddress, userAgent });
